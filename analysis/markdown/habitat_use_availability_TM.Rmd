...
Habitat selected by radio-tagged juvenile Chinook salmon, during late fall and winter months, were fairly proportional to the available habitat among sinuosity categories (Figure \@ref(fig:sin-use)). In other words, Chinook salmon presmolts were *not* observed using reaches of the lower Lemhi River classified as "high sinuosity" at a higher rate than was available, which would suggest a preference. However, this could be due to fish not selecting for habitat on a more coarse (e.g., reach) scale, but rather on a finer (e.g., microhabitat) scale.<!-- This final statement is likely more appropriate for the Discussion-->
