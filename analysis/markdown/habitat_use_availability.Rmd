...
Mean stream velocities used by Chinook salmon presmolts were significantly lower than those available both throughout the lower Lemhi River and by sinuousity class (Figure \@ref(fig:depth-fig)); Table \@ref(tab:vel-tab); Table \@ref(tab:vel-sin-tab)), suggesting that presmolts were selecting for slower water habitats during late fall and early winter months.
